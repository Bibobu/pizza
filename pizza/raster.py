...
class raster:
    ...
    def label(self, x, y, font, point, color, text):
        ...
        labs = [x, y, fontlist[font], point / 3.0, "Left", scaledcolor, text]
    ...
    def all(self, *args):
        ...
        # distance from 1st snapshot box
        # or max box for all selected steps
        # pre-call single() to re-center
        # simulation data on 1st step or if panning
    ...
    def single(self, flag, file, box, atoms, bonds, tris, lines):
        ...
        for atom in atoms:
            itype = int(atom[1])
            if itype > ncolor:
                sys.exit("atom type too big")
            color = self.vizinfo.acolor[itype]
            rad = self.vizinfo.arad[itype]
            f.write("{}\n".format(2))
            f.write("{} {} {} {} {} {} {}\n".format(
                atom[2], atom[3], atom[4], rad, color[0], color[1], color[2]
                )
            )
        ...
        for line in lines:
            ...
            f.write("{}\n".format(3))
            f.write("{} {} {} {} {} {} {} {} {} {} {}\n".format(
                line[2], line[3], line[4], thick,
                line[5], line[6], line[7], thick,
                color[0], color[1], color[2]
                )
            )
        ...
        for label in self.labels:
            f.write("{}\n".format(15))
            f.write("{}\n".format(10))
            f.write("{} {} {}\n".format(label[2], label[3], label[4]))
            f.write("{}\n".format(11))
            f.write("{} {} {} {} {} {}\n".format(
                label[0], label[1], 0.0,
                label[5][0], label[5][1], label[5][2]
                )
            )
            f.write("{}\n".format(label[6]))
