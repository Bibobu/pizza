...
class cfg:
    ...
    def one(self, *args):
        ...
        while 1:
            ...
            f.write("# Timestep %d \n#\nA = 1.0 Angstrom\n" % time)
            f.write("H0(1,1) = %20.10f A \n" % xlen)
            f.write("H0(1,2) = 0.0 A \n")
            f.write("H0(1,3) = 0.0 A \n")
            f.write("H0(2,1) = 0.0 A \n")
            f.write("H0(2,2) = %20.10f A \n" % ylen)
            f.write("H0(2,3) = 0.0 A \n")
            f.write("H0(3,1) = 0.0 A \n")
            f.write("H0(3,2) = 0.0 A \n")
            f.write("H0(3,3) = %20.10f A \n" % zlen)
            f.write("#\n")
            ...
            for atom in atoms:
                ...
                f.write("1.0  %d   %15.10f  %15.10f  %15.10f  0.0 0.0 0.0 \n" % (
                    itype,
                    xfrac,
                    yfrac,
                    zfrac,
